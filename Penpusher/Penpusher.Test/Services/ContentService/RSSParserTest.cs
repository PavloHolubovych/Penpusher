...
namespace Penpusher.Test.Services.ContentService
{
    ...
    class RssParserTest : TestBase
    {
        ...
        public void GetParsedArticlesTest()
        {
            ...
            {
                new Article() { Date = DateTime.Parse("Mon, 23 May 2016 00:00:00 -0500"), Description = "Test Description", Link = "Test link1", Title = "Test Title1", Id = 0, IdNewsProvider = 1, UsersArticles = null },
                new Article() { Date = DateTime.Parse("Mon, 23 May 2016 00:00:00 -0500"), Description = "Test Description", Link = "Test link2", Title = "Test Title2", Id = 0, IdNewsProvider = 1, UsersArticles = null  },
                new Article() { Date = DateTime.Parse("Mon, 23 May 2016 00:00:00 -0500"), Description = "Test Description", Link = "Test link3", Title = "Test Title3", Id = 0, IdNewsProvider = 1, UsersArticles = null  }
            };

            var actual = MockKernel.Get<IParser>().GetParsedArticles(rssModel);
